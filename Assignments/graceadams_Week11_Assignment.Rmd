...
if_else(crab_size >= 20, "large",
        if_else(crab_size >= 10 & crab_size < 20, "medium", if_else(crab_size < 10, "small", NA)))
```
...
case_when(crab_size >= 20 ~ "large",
          crab_size >= 10 & crab_size < 20 ~ "medium",
          crab_size < 10 ~ "small", 
          TRUE ~ NA)
```
