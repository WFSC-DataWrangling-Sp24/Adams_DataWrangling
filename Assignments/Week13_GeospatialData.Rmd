...
![Raster data have a fixed resolution and become "pixelated" when magnifyings](image_files/zoom-raster.png)

![Vector data do not lose resolution when magnifying](image_files/zoom-vector.png)
...
![Mean annual temperature of southwestern North America](image_files/sw-desert-heat.png)
...
temp <- rast("image_files/global_temperature.tif")
```
...
![Example of palette name in ColorBrewer, YlOrBr](image_files/colorbrewer-palette-name.png)
