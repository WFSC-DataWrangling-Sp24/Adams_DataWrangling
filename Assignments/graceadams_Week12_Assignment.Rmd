...
##### I had a really hard time on this question, probably just from the long time since we covered this in class. I used Chat GPT to help on some parts of the question, hence the "seq_along" in the for loop.
